      ...
      <main className="flex-1 px-4 py-8 sm:py-12">
        <div className="mx-auto max-w-lg">
          {mounted ? (
            <>
              {/* Form Card */}
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8 animate-in fade-in duration-700">
                ...
                <div className="mb-5">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      const sub = subdistricts.find((s) => String(s.id) === e.target.value);
                      setSelectedSubdistName(sub?.name || "");
                    }}
                ...
                {/* Berat */}
                <div className="mb-6">
                  <label className="block text-sm font-semibold text-gray-600 mb-1.5">Berat (kg)</label>
                  <input
                    type="number"
                    value={weight}
                    readOnly
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-500 text-sm outline-none cursor-not-allowed"
                  />
                  <p className="mt-1.5 text-[10px] text-gray-400 italic">
                    * Berat dikunci 1kg per box hamster
                  </p>
                </div>
              ...
              {results.length > 0 && (
                <div 
                  ref={resultsRef}
                  className="mt-8 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden scroll-mt-6 animate-in slide-in-from-bottom-4 duration-500"
                >
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
              <div className="h-6 w-48 bg-gray-100 rounded mb-8 animate-pulse" />
              <div className="space-y-6">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i}>
                    <div className="h-4 w-24 bg-gray-50 rounded mb-2 animate-pulse" />
