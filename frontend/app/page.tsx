      ...
      <header className="relative overflow-hidden bg-gradient-to-br from-brand-800 via-brand-700 to-brand-600 flex-1 flex items-center justify-center">
        ...
        <div className="relative mx-auto max-w-md px-6 py-16 text-center sm:py-20">
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
            ...
            >
              {/* Icon katalog — taruh file di frontend/public/icon-katalog.png */}
              ...
              <span className="text-base font-bold text-gray-900">Lihat Katalog</span>
              <span className="text-xs text-gray-500 font-medium">Lihat koleksi hamster kami</span>
            </Link>
            ...
            >
              ...
              <span className="text-xs text-white/80">Langsung chat untuk transaksi</span>
            </a>
          </div>
        </div>
